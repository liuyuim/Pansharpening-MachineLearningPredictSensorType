...
from data8b import Dataset_Pro
import scipy.io as sio
from model8b import WSDFNet
import numpy as np
import shutil
...
python Runtrain8b.py

'''
if __name__ == "__main__":

    # train_set = Dataset_Pro('/path/to/train/set')  # creat data for training
    train_set = Dataset_Pro('G:\AFusionGroup\Shiyan\shiyan20230421\WV2_Data\Train\W_H_C_N.mat')  
    training_data_loader = DataLoader(dataset=train_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches
    # creat data for validation
    # validate_set = Dataset_Pro('/path/to/validate/set')
    validate_set = Dataset_Pro('G:\AFusionGroup\Shiyan\shiyan20230421\WV2_Data\Validation\W_H_C_N.mat')
    validate_data_loader = DataLoader(dataset=validate_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches
    model_out_path = 'G:/AFusionGroup/Shiyan/shiyan20230421/WV2_WSDFNet/SaveModel'
    train(training_data_loader, validate_data_loader, model_out_path)



    # train_set = Dataset_Pro('/path/to/train/set')  # creat data for training
    train_set = Dataset_Pro('G:\AFusionGroup\Shiyan\shiyan20230421\WV3_Data\Train\W_H_C_N.mat')  
    training_data_loader = DataLoader(dataset=train_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches
    # creat data for validation
    # validate_set = Dataset_Pro('/path/to/validate/set')
    validate_set = Dataset_Pro('G:\AFusionGroup\Shiyan\shiyan20230421\WV3_Data\Validation\W_H_C_N.mat')
    validate_data_loader = DataLoader(dataset=validate_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                      pin_memory=True, drop_last=True)  # put training data to DataLoader for batches
    model_out_path = 'G:/AFusionGroup/Shiyan/shiyan20230421/WV3_WSDFNet/SaveModel'
    train(training_data_loader, validate_data_loader, model_out_path)