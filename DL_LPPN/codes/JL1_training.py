...
from JL1_model import GaussianPyramid, LPPN
...
image_size = 64
model_directory = 'D:/LiuYu/shiyan/JL1_LPPN/SaveModel'  # directory to save trained model to.
# training data in .mat format
train_data_name = 'D:/LiuYu/shiyan/JL1_Data/Train/N_H_W_C.mat'
# validation data in .mat format
test_data_name = 'D:/LiuYu/shiyan/JL1_Data/Validation/N_H_W_C.mat'
...
if __name__ == '__main__':
    ...
    # kernel generation
    ms_kernel_name = './kernels/JL1_ms_kernel.mat' # corresponding multispectral MTF kernel
    ...
    pan_kernel_name = './kernels/JL1_pan_kernel.mat' # corresponding panchromatic MTF kernel
