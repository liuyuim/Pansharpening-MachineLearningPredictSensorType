...
from WV4b4_model import GaussianPyramid, LPPN
...
image_size = 64
model_directory = 'D:/LiuYu/shiyan/WV4_LPPN/SaveModel'  # directory to save trained model to.
# training data in .mat format
train_data_name = 'D:/LiuYu/shiyan/WV4_Data/Train/N_H_W_C.mat'
# validation data in .mat format
test_data_name = 'D:/LiuYu/shiyan/WV4_Data/Validation/N_H_W_C.mat'
...
if __name__ == '__main__':
    ...
    # kernel generation
    ms_kernel_name = './kernels/WV4_ms_kernel.mat' # corresponding multispectral MTF kernel
    ...
    pan_kernel_name = './kernels/WV4_pan_kernel.mat' # corresponding panchromatic MTF kernel
