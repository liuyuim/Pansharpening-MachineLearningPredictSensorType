...
if __name__ == '__main__':
    ...
    test_data = 'E:/LiuYu/FusionEvaluateExperiment/MethodDL_LPPN/codes/test_data/WorldView3.mat'
    model_directory = 'E:/LiuYu/FusionEvaluateExperiment/MethodDL_LPPN/codes/models/models_WV4'
    ...
    output_pyramid = WV4b4_model.LPPN(pan_p, ms_p)
    ...
    with tf.Session() as sess:
        ...
        sio.savemat('./result/output_WV4.mat', {'output_LPPN': final_output[0, :, :, :]})
