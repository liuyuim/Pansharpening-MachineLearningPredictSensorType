...
feature_num = 128  # number of feature maps, 64 for WorldView-3 datasets, 128 for QuickBird and GaoFen-2 datasets
ms_channels_num = 4  # channel number of multispectral images, 8 for WorldView-3 datasets, 4 for QuickBird and
# GaoFen-2 datasets
# concat_channels_num = 9
concat_channels_num = 5
weight_decay = 1e-5

tf.compat.v1.reset_default_graph()
os.environ['CUDA_VISIBLE_DEVICES'] = '0'  # set CUDA devices for multi GPU training
...
def LPPN(pan, ms):
    with tf.compat.v1.variable_scope('LPPN', reuse=tf.compat.v1.AUTO_REUSE):
        # kernel generation
        ms_kernel_name = './kernels/IKONOS_ms_kernel.mat'  # read the corresponding multispectral kernel (WorldView-3
        ...
        pan_raw_kernel_name = './kernels/IKONOS_pan_kernel.mat'   # read the corresponding panchromatic kernel (WorldView-3),
