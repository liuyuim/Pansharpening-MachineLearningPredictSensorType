...
# cd/d C:\Users\LiuYu\Desktop\FusionEvaluateExperiment\MethodDL_LPPN\codes
# python IKb4_training.py
...
from IKb4_model import GaussianPyramid, LPPN
...
image_size = 64
model_directory = 'D:/LiuYu/shiyan/IK_LPPN/SaveModel'  # directory to save trained model to.
# training data in .mat format
train_data_name = 'D:/LiuYu/shiyan/IK_Data/Train/N_H_W_C.mat'
# validation data in .mat format
test_data_name = 'D:/LiuYu/shiyan/IK_Data/Validation/N_H_W_C.mat'
#data = hdf5storage.loadmat(test_data_name)
...
if __name__ == '__main__':
    ...
    train_data = sio.loadmat(train_data_name) # scipy.io.loadmat
    ...
    # kernel generation
    ms_kernel_name = './kernels/IKONOS_ms_kernel.mat' # corresponding multispectral MTF kernel
    ...
    pan_kernel_name = './kernels/IKONOS_pan_kernel.mat' # corresponding panchromatic MTF kernel
