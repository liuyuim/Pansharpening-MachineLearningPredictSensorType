...
def LPPN(pan, ms):
    with tf.compat.v1.variable_scope('LPPN', reuse=tf.compat.v1.AUTO_REUSE):
        # kernel generation
        ms_kernel_name = './kernels/GF2_ms_kernel.mat'  # read the corresponding multispectral kernel (WorldView-3
        ...
        pan_raw_kernel_name = './kernels/GF2_pan_kernel.mat'   # read the corresponding panchromatic kernel (WorldView-3),
