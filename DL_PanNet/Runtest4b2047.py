...
if __name__=='__main__':# 正常融合  二级目录结构  
    ...
    Datapath = 'F:/AFusionGroup/Shiyan/shiyan20230706/IK_Data/Test_Fu'
    saveDir = 'F:/AFusionGroup/Shiyan/shiyan20230706/IK_PanNet/HypothesisOutput_Fu'
    # sensor_list = ['GF1_*','GF2_*','QB_*','WV2_*','WV3_*'] # sensor_list 和 model_directory_list 两个列表内的元素需要一一对应
    sensor_list = ['QB_*'] # sensor_list 和 model_directory_list 两个列表内的元素需要一一对应
    ...
    model_directory_list = ['F:/AFusionGroup/Shiyan/shiyan20230706/IK_PanNet/SaveModel/']
    #预测实验统计评估值的分布特征
