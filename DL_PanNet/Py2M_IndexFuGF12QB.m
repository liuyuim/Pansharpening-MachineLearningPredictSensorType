...
% GF1
TestOutputYijiPath='..\..\Tmp\IndexStatistics100_jianshe\GF1_1\HypothesisOutput\'; %测试集经过深度学习test代码得出的五个假设融合结果，
TestDataYijiPath='..\..\Tmp\IndexStatistics100_jianshe\GF1_1\TestData_Fu\'; %测试集
saveDir = '..\..\Tmp\IndexStatistics100_jianshe\GF1_1\PannetEvaluate\';%设置对应保存路径
...
% % GF2
% TestOutputYijiPath='..\..\Tmp\IndexStatistics100_jianshe\GF2_2\HypothesisOutput\'; %测试集经过深度学习test代码得出的五个假设融合结果，
% TestDataYijiPath='..\..\Tmp\IndexStatistics100_jianshe\GF2_2\TestData_Fu\'; %测试集
% saveDir = '..\..\Tmp\IndexStatistics100_jianshe\GF2_2\PannetEvaluate\';%设置对应保存路径
% IndexFuDR (TestOutputYijiPath,TestDataYijiPath,saveDir);
% % IndexStatisticsFuDR
% Index_Sensor = "GF2";
% IndexStatisticsFuDR (saveDir);
...
% QB
TestOutputYijiPath='..\..\Tmp\IndexStatistics100_jianshe\QB_1\HypothesisOutput\'; %测试集经过深度学习test代码得出的五个假设融合结果，
TestDataYijiPath='..\..\Tmp\IndexStatistics100_jianshe\QB_1\TestData_Fu\'; %测试集
saveDir = '..\..\Tmp\IndexStatistics100_jianshe\QB_1\PannetEvaluate\';%设置对应保存路径
IndexFuDR (TestOutputYijiPath,TestDataYijiPath,saveDir);
% IndexStatisticsFuDR
Index_Sensor = "QB";
IndexStatisticsFuDR (saveDir);
