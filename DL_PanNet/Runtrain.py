...
def run_main(model_directory,train_data_name,test_data_name,num_spectral):


    tf.compat.v1.reset_default_graph()

    num_spectral     = num_spectral    # channel size
    ...
    # model_directory  = './models_GF1'                            # directory to save trained model to.
    # train_data_name  = './training_data/GF1_train.mat'           # training data
    # test_data_name   = './training_data/GF1_validation.mat'      # validation data
...
############## placeholder for training
    ...
    gt     = tf.compat.v1.placeholder(dtype=tf.float32, shape=[train_batch_size,image_size,image_size,num_spectral])

    lms    = tf.compat.v1.placeholder(dtype=tf.float32, shape=[train_batch_size,image_size,image_size,num_spectral])
    ms_hp  = tf.compat.v1.placeholder(dtype=tf.float32, shape=[train_batch_size,image_size//4,image_size//4,num_spectral])
    pan_hp = tf.compat.v1.placeholder(dtype=tf.float32, shape=[train_batch_size,image_size,image_size,1])
    

############# placeholder for testing

    test_gt     = tf.compat.v1.placeholder(dtype=tf.float32,shape=[test_batch_size,image_size,image_size,num_spectral])

    test_lms    = tf.compat.v1.placeholder(dtype=tf.float32,shape=[test_batch_size,image_size,image_size,num_spectral])
    test_ms_hp  = tf.compat.v1.placeholder(dtype=tf.float32,shape=[test_batch_size,image_size//4,image_size//4,num_spectral])
...
# if __name__ =='__main__':
    ...
    # model_directory  = './models_GF2'                            # directory to save trained model to.
    # train_data_name  = './training_data/GF2_train.mat'           # training data
    # test_data_name   = './training_data/GF2_validation.mat'      # validation data
    # run_main(model_directory,train_data_name,test_data_name,num_spectral)
