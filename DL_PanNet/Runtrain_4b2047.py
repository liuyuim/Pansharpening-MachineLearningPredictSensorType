...
def run_main(model_directory,train_data_name,test_data_name):
    ...
    train_batch_size = 8  # 32  # training batch size   16:1960 32:1210 64:2020 128:2140
    test_batch_size  = 8  # 32  # validation batch size
    image_size       = 64   # patch size
    iterations       = 255000 # 255000 #30 # total number of iterations to use.
