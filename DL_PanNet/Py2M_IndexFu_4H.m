...
% TestOutputYijiPath='..\..\Tmp\Train_Validation_Test_data\GF1.1\PannetOutputToIndex\'; %测试集经过深度学习test代码得出的五个假设融合结果，
% TestDataYijiPath='..\..\Tmp\Train_Validation_Test_data\GF1.1\TestData_Fu\'; %测试集
% saveDir = '..\..\Tmp\Train_Validation_Test_data\GF1.1\PannetIndex\';%设置对应保存路径
% IndexFuDR (TestOutputYijiPath,TestDataYijiPath,saveDir);IndexStatisticsJianshe


TestOutputYijiPath='..\..\Tmp\IndexStatisticsjianshe\WV3_1\HypothesisOutput\'; %测试集经过深度学习test代码得出的五个假设融合结果，
TestDataYijiPath='..\..\Tmp\IndexStatisticsjianshe\WV3_1\TestData_Fu\'; %测试集
saveDir = '..\..\Tmp\IndexStatisticsJianshe\WV3_1\PannetEvaluate-wv2\';%设置对应保存路径
