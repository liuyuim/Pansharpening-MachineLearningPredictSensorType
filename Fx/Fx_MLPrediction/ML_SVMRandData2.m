...
function [] = ML_SVMRandData2(EvaluationDirList1,TrainProportion,EvaluationDirList2,TestProportion,columnSample)
    ...
    %% 混淆矩阵
    figure
    cm = confusionchart(label1(test_id), predict_label);
