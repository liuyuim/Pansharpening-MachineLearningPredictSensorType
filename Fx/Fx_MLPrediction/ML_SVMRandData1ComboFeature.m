...
function [] = ML_SVMRandData1ComboFeature(EvaluationDirList,TrainProportion,columnSample)    
    ...
    saveName = strcat("ML_SVMRandData1ComboFeature",  string(datetime, 'yyyy-MM-dd-HH-mm-ss'), '.mat');
